...
func TestPublishWithCAPinning(t *testing.T) {

	oldPass := testPassphrase
	testPassphrase = "iamcyc93826"

	setUp(t)
	rootDir := "/Users/xjqw46/test/capin"
	privateKeyFN := rootDir + "/priv.key"
	publicKeyFN := rootDir + "/pub.crt"
	...
	output, err := runCommand(t, tempDir,
		"-s", server.URL,
		"init", gun,
		"--rootkey", privateKeyFN,
		"--rootcert", publicKeyFN)
	require.NoError(t, err)
...
>>>>>>> a794dd4c7ad456de59d39f807c0266d30817d519
